def test_search_tasks_by_location_and_budget(client):
    """Test Case: Search Tasks by Location and Budget"""
    ...
    # Step 3: Define the max budget and location to search
    max_budget = 100
    location = 'Test City'

    # Step 4: Perform the search by location and budget
    search_response = client.post('/filter_jobs', data={
        'location': location,
        'budget': max_budget  # Send both location and budget as form parameters
    })
