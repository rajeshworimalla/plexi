...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 02, 2024 at 12:27 PM
...
(23, 31, 211, '2024-12-02 09:33:43'),
(24, 31, 218, '2024-12-02 09:42:58'),
(25, 31, 1, '2024-12-02 10:34:17'),
(26, 31, 205, '2024-12-02 10:34:43'),
(27, 31, 214, '2024-12-02 10:35:19'),
(28, 31, 217, '2024-12-02 10:35:53'),
(29, 31, 216, '2024-12-02 10:36:10');
...
INSERT INTO `jobs` (`job_id`, `title`, `employer`, `salary`, `location`, `description`, `requester_id`, `phone`, `email`, `date_added`, `status`) VALUES
(1, 'Software Developer', 'Tech Innovators', 85000, 'New York, NY', 'Develop and maintain software applications.', 101, '123-456-7890', 'hr@techinnovators.com', NULL, 'Recruiting'),
(2, 'Data Analyst', 'DataWiz Corp', 70000, 'San Francisco, CA', 'Analyze data trends to support business decisions.', 102, '987-654-3210', 'careers@datawiz.com', NULL, 'Recruiting'),
(3, 'Graphic Designer', 'Creative Studio', 55000, 'Austin, TX', 'Design marketing materials and branding assets.', 103, '456-123-7890', 'jobs@creativestudio.com', NULL, 'Recruiting'),
(4, 'Project Manager', 'BuildIt Inc', 90000, 'Chicago, IL', 'Manage project timelines and deliverables.', 104, '321-654-9870', 'pm@buildit.com', NULL, 'Recruiting'),
(5, 'Marketing Specialist', 'AdVentures LLC', 60000, 'Miami, FL', 'Develop and execute marketing campaigns.', 105, '789-456-1230', 'marketing@adventures.com', NULL, 'Recruiting'),
(6, 'IT Support Specialist', 'NetSecure Solutions', 50000, 'Dallas, TX', 'Provide technical support and troubleshoot issues.', 106, '567-890-1234', 'itsupport@netsecure.com', NULL, 'Recruiting'),
(7, 'HR Coordinator', 'PeopleFirst HR', 52000, 'Seattle, WA', 'Assist with recruitment and employee relations.', 107, '123-789-4560', 'hr@peoplefirst.com', NULL, 'Recruiting'),
(8, 'Accountant', 'FinancePros', 62000, 'Denver, CO', 'Manage financial records and prepare reports.', 108, '890-567-1234', 'accounting@financepros.com', NULL, 'Recruiting'),
(9, 'Content Writer', 'WriteWell Agency', 45000, 'Portland, OR', 'Create engaging content for blogs and websites.', 109, '654-321-9870', 'jobs@writewell.com', NULL, 'Recruiting'),
(10, 'Web Developer', 'CodeCraft', 78000, 'Boston, MA', 'Build and maintain websites and web apps.', 110, '567-123-8901', 'careers@codecraft.com', NULL, 'Recruiting'),
(11, 'UX Designer', 'DesignHub', 80000, 'San Jose, CA', 'Design user-friendly interfaces for web and mobile.', 111, '789-012-3456', 'hr@designhub.com', NULL, 'Recruiting'),
(12, 'Operations Manager', 'LogiTech', 95000, 'Atlanta, GA', 'Oversee daily operations and logistics.', 112, '234-567-8901', 'operations@logitech.com', NULL, 'Recruiting'),
(13, 'Research Scientist', 'BioTech Labs', 100000, 'San Diego, CA', 'Conduct research and develop new products.', 113, '432-109-8765', 'research@biotechlabs.com', NULL, 'Recruiting'),
(14, 'Social Media Manager', 'TrendMakers', 58000, 'Orlando, FL', 'Manage social media channels and campaigns.', 114, '210-345-6789', 'socialmedia@trendmakers.com', NULL, 'Recruiting'),
(15, 'Customer Service Rep', 'ClientCare Inc', 42000, 'Houston, TX', 'Handle customer inquiries and resolve issues.', 115, '789-654-1234', 'support@clientcare.com', NULL, 'Recruiting'),
(16, 'Sales Representative', 'Global Reach', 55000, 'Las Vegas, NV', 'Drive sales and maintain client relationships.', 116, '876-543-2109', 'sales@globalreach.com', NULL, 'Recruiting'),
(17, 'Teacher', 'LearningTree Academy', 40000, 'Phoenix, AZ', 'Teach and mentor students in a classroom setting.', 117, '321-678-5432', 'careers@learningtree.com', NULL, 'Recruiting'),
(18, 'Mechanical Engineer', 'Engineered Solutions', 85000, 'Detroit, MI', 'Design and test mechanical components.', 118, '123-543-6789', 'engineers@engineeredsolutions.com', NULL, 'Recruiting'),
(19, 'Business Analyst', 'CorpConsult', 75000, 'Charlotte, NC', 'Analyze business needs and recommend solutions.', 119, '765-432-1098', 'jobs@corpconsult.com', NULL, 'Recruiting'),
(20, 'Photographer', 'Picture Perfect Studios', 35000, 'Nashville, TN', 'Capture and edit professional photographs.', 120, '543-210-9876', 'info@pictureperfect.com', NULL, 'Recruiting'),
(41, 'testjob', 'requester', 5, 'kansas, kentucky', 'life aint daijobu', 31, '123123', 'requester@gmail.com', '2024-11-30 19:18:38', 'Completed'),
(46, 'helloworld', 'requester', 5, 'catmandu', 'idk bro', 31, '123123', 'requester@gmail.com', '2024-12-01 19:00:06', 'Completed'),
(47, 'testjob2', 'requester123', 51, 'dogmandu', 'chill', 31, '123123', 'requester123@gmail.com', '2024-12-01 20:44:44', 'Completed'),
(48, 'test345123', 'requester', 5123120, 'adfsadf', 'sfsadfsadf', 31, '123123', 'requester123@gmail.com', '2024-12-02 17:05:49', 'Completed');
...
(26, 23, 31, 'hello ivy', '2024-12-02 09:33:49'),
(27, 24, 31, 'hello', '2024-12-02 09:43:05'),
(28, 28, 31, 'sdfsad', '2024-12-02 10:35:58');
...
(31, 'requester', 'password123', 'requester123@gmail.com', 'requester', '                        test234\r\n        \r\n        ', 'test345', 90, 123, 'test', '123123', '2024-11-13 08:50:48'),
